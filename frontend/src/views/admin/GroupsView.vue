                ...
                <div class="flex-1 space-y-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          @click="
                            removeSelectedAccount(index, account.id, false)
                          "
                        >
                          <Icon name="x" size="xs" />
                        </button>
                    ...
                    <div class="relative account-search-container">
                      ...
                      <div
                        v-if="
                          showAccountDropdown[`create-${index}`] &&
                          accountSearchResults[`create-${index}`]?.length > 0
                        "
                ...
                <div class="flex-1 space-y-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          class="ml-0.5 text-primary-500 hover:text-primary-700 dark:hover:text-primary-200"
                          @click="
                            removeSelectedAccount(index, account.id, true)
                          "
                        >
                          <Icon name="x" size="xs" />
                        </button>
                    ...
                    <div class="relative account-search-container">
                      ...
                      <div
                        v-if="
                          showAccountDropdown[`edit-${index}`] &&
                          accountSearchResults[`edit-${index}`]?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border bg-white shadow-lg dark:border-dark-600 dark:bg-dark-800"
                      >
                        <button
...
const searchAccounts = async (key: string) => {
  ...
  accountSearchTimeout = setTimeout(async () => {
    ...
    try {
      ...
      accountSearchResults.value[key] = res.items.map((a) => ({
        id: a.id,
        name: a.name,
      }));
    } catch {
