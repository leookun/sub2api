...
function buildQuery(
  overrides: Partial<AlertEventsQuery> = {},
): AlertEventsQuery {
...
function formatDurationLabel(event: AlertEvent): string {
  ...
  if (resolvedAtStr) {
    ...
    if (!Number.isNaN(resolvedAt.getTime())) {
      ...
      const prefix = status === "manual_resolved" ? "手动已解决" : "已恢复";
...
function formatDimensionsSummary(event: AlertEvent): string {
  ...
  if (groupId != null && groupId !== "")
    parts.push(`group_id=${String(groupId)}`);
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
          ...
          >
            ...
            >
              ...
              <td class="whitespace-nowrap px-4 py-3">
                <div class="flex items-center gap-2">
                  <span
                    ...
                    :class="severityBadgeClass(String(row.severity || ''))"
                  >
                    {{ row.severity || "-" }}
                  </span>
                  <span
              ...
              <td
                class="min-w-[260px] px-4 py-3 text-xs text-gray-700 dark:text-gray-200"
              >
              ...
              <td
                class="whitespace-nowrap px-4 py-3 text-[11px] text-gray-500 dark:text-gray-400"
              >
    ...
    >
      ...
      <div v-else class="space-y-5">
          ...
          >
            <div>
              <div class="flex flex-wrap items-center gap-2">
                <span
                  class="inline-flex items-center rounded-full px-2 py-1 text-[10px] font-bold"
                  :class="severityBadgeClass(String(selected.severity || ''))"
                >
                  {{ selected.severity || "-" }}
                </span>
                <span
            ...
            <div class="flex flex-wrap gap-2">
              <div
                class="flex items-center gap-2 rounded-lg bg-white px-2 py-1 ring-1 ring-gray-200 dark:bg-dark-800 dark:ring-dark-700"
              >
                <span
                  class="text-[11px] font-bold text-gray-600 dark:text-gray-300"
                  >忽略此告警</span
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
            ...
            <div class="mt-1 text-sm text-gray-900 dark:text-white">
              ...
              <div v-if="selected.dimensions?.group_id">
                group_id={{ selected.dimensions.group_id }}
              </div>
              <div v-if="getDimensionString(selected, 'region')">
        ...
        >
          ...
          >
            <table
              class="min-w-full divide-y divide-gray-100 dark:divide-dark-700"
            >
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-dark-700">
                ...
                >
                  <td
                    class="px-3 py-2 text-xs text-gray-600 dark:text-gray-300"
                  >
                  ...
                  >
                    <span
                      v-if="
                        typeof it.metric_value === 'number' &&
                        typeof it.threshold_value === 'number'
                      "
                    >
                      {{ it.metric_value.toFixed(2) }} /
                      {{ it.threshold_value.toFixed(2) }}
                    </span>
                    <span v-else>-</span>
                  </td>
                </tr>
