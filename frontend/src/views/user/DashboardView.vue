  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <UserDashboardCharts v-model:start-date="startDate" v-model:end-date="endDate" v-model:granularity="granularity" :loading="loadingCharts" :trend="trendData" :models="modelStats" @dateRangeChange="loadCharts" @granularityChange="loadCharts" />
