...
export async function getConcurrencyStats(
  ...
  const { data } = await apiClient.get<OpsConcurrencyStatsResponse>(
...
export function subscribeQPS(
  ...
  const maxReconnectAttempts = Number.isFinite(
  ...
  const connect = () => {
    ...
    const rawToken = String(
      options.token ?? localStorage.getItem("auth_token") ?? "",
    ).trim();
...
export async function getDashboardOverview(
  ...
  const { data } = await apiClient.get<OpsDashboardOverview>(
...
export async function getErrorTrend(
  ...
  const { data } = await apiClient.get<OpsErrorTrendResponse>(
    "/admin/ops/dashboard/error-trend",
    {
      params,
      signal: options.signal,
    },
...
export async function listErrorLogs(
  ...
  const { data } = await apiClient.get<OpsErrorLogsResponse>(
    "/admin/ops/errors",
    { params },
  );
  return data;
...
export async function listRetryAttempts(
  errorId: number,
  limit = 50,
): Promise<OpsRetryAttempt[]> {
  const { data } = await apiClient.get<OpsRetryAttempt[]>(
    `/admin/ops/errors/${errorId}/retries`,
    { params: { limit } },
  );
  return data;
}

export async function updateErrorResolved(
  errorId: number,
  resolved: boolean,
): Promise<void> {
...
export async function getRequestErrorDetail(
  id: number,
): Promise<OpsErrorDetail> {
  const { data } = await apiClient.get<OpsErrorDetail>(
    `/admin/ops/request-errors/${id}`,
  );
  return data;
}

export async function getUpstreamErrorDetail(
  id: number,
): Promise<OpsErrorDetail> {
  const { data } = await apiClient.get<OpsErrorDetail>(
    `/admin/ops/upstream-errors/${id}`,
  );
  return data;
}

export async function retryRequestErrorClient(
  id: number,
): Promise<OpsRetryResult> {
  const { data } = await apiClient.post<OpsRetryResult>(
...
export async function updateRequestErrorResolved(
  ...
  await apiClient.put(`/admin/ops/request-errors/${errorId}/resolve`, {
    resolved,
  });
}
...
export async function updateUpstreamErrorResolved(
  ...
  await apiClient.put(`/admin/ops/upstream-errors/${errorId}/resolve`, {
    resolved,
  });
}
...
export async function listRequestDetails(
  ...
  const { data } = await apiClient.get<OpsRequestDetailsResponse>(
    "/admin/ops/requests",
    { params },
  );
  return data;
...
export async function updateAlertRule(
  ...
  const { data } = await apiClient.put<AlertRule>(
...
export async function listAlertEvents(
  ...
  const { data } = await apiClient.get<AlertEvent[]>(
...
export async function getAlertRuntimeSettings(): Promise<OpsAlertRuntimeSettings> {
  const { data } = await apiClient.get<OpsAlertRuntimeSettings>(
...
export async function updateAlertRuntimeSettings(
  ...
  const { data } = await apiClient.put<OpsAlertRuntimeSettings>(
    "/admin/ops/runtime/alert",
    config,
  );
  return data;
...
export async function getAdvancedSettings(): Promise<OpsAdvancedSettings> {
  const { data } = await apiClient.get<OpsAdvancedSettings>(
...
export async function updateAdvancedSettings(
  ...
  const { data } = await apiClient.put<OpsAdvancedSettings>(
    "/admin/ops/advanced-settings",
    config,
  );
  return data;
...
async function getMetricThresholds(): Promise<OpsMetricThresholds> {
  const { data } = await apiClient.get<OpsMetricThresholds>(
    "/admin/ops/settings/metric-thresholds",
  );
  return data;
}

async function updateMetricThresholds(
