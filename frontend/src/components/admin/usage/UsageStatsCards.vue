<template>
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4 flex items-center gap-3">
      <div
        class="rounded-lg bg-amber-100 p-2 dark:bg-amber-900/30 text-amber-600"
      >
        <svg
          class="h-5 w-5"
          fill="none"
    ...
    <div class="card p-4 flex items-center gap-3">
      <div
        class="rounded-lg bg-green-100 p-2 dark:bg-green-900/30 text-green-600"
      >
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xl font-bold text-green-600">
          ${{
            (
              (stats?.total_account_cost ?? stats?.total_actual_cost) ||
              0
            ).toFixed(4)
          }}
        </p>
    ...
    <div class="card p-4 flex items-center gap-3">
      <div
        class="rounded-lg bg-purple-100 p-2 dark:bg-purple-900/30 text-purple-600"
      >
