      ...
      >
        ...
        <div v-if="step === 0" class="space-y-6">
          ...
          <template v-else>
            ...
            <div
              v-if="verifyError"
              class="rounded-lg bg-red-50 p-3 text-sm text-red-700 dark:bg-red-900/30 dark:text-red-400"
            >
              {{ verifyError }}
            </div>
        ...
        <div v-if="step === 1" class="space-y-6">
          ...
          <template v-if="setupData">
            <div class="flex justify-center">
              <div
                class="rounded-lg border border-gray-200 p-4 bg-white dark:border-dark-600 dark:bg-white"
              >
            ...
            <div class="text-center">
              ...
              <div class="flex items-center justify-center gap-2">
                <code
                  class="rounded bg-gray-100 px-3 py-2 font-mono text-sm dark:bg-dark-700"
                >
                  {{ setupData.secret }}
                </code>
                <button
